            ...
            <main className={styles.main}>
                ...
                <div className={styles.grid}>
                    <Link href="/unityprojects" passHref className={styles.card}>
                            ...
                            <p className={inter.className}>View Unity projects currently under development.</p>
                    </Link>
                    <Link href="/otherprojects" className={styles.card}>
                        <h2 className={inter.className}>
                            Other Projects<span>-&gt;</span>
                        </h2>
                        <p className={inter.className}>View other external projects.</p>
                    </Link>
                    <Link href="/localprojects" className={styles.card}>
                        <h2 className={inter.className}>
